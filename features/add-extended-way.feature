Feature: app:operations:add command
  ...
  Scenario: Add two integers
    ...
    And the command have in his log "The integer sum of 2 and 3 is 5."
  ...
  Scenario: Add two floats converted to int before addition
    ...
    And the command have in his log "The integer sum of 2.1 and 3.9 is 6."
    And the command return code is "0"
  ...
  Scenario: Add one integer raises exception
    ...
    And the command have in his log "1 number(s) were passed to the command. Only several are allowed."
  ...
  Scenario: Add three integers
    ...
    And the command have in his log "The integer sum of 2 and 3 and 4 is 9."
    And the command return code is "0"
