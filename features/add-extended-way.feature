Feature: app:operations:add command
  ...
  Scenario: Add two integers
    ...
    And the command have in his log "The integer sum of 2 and 3 is 5." with "INFO"
  ...
  Scenario: Add two floats converted to int before addition
    ...
    And the command have in his log "The integer sum of 2.1 and 3.9 is 6." with "INFO"
    And the command return code is "0"
  ...
  Scenario: Add three integers
    ...
    And the command have in his log "The integer sum of 2 and 3 and 4 is 9." with "INFO"
    And the command return code is "0"
